...
class BinaryComposeCopyDataset(IterableDataset):
    ...
    def __init__(
        self, seed=0, d=10, seq_length=5, batch_size=64, horizon=36, generator_stop=2000
    ):
        self.d = d
    ...
    def __iter__(self):
        for i in range(self.generator_stop):
            ...
            for step in range(self.horizon):
                ...
                y_sample[composed_seq_id, :, :] = torch.diagonal(
                    y_sample[step:composed_seq_id], dim1=0, dim2=2
                )
