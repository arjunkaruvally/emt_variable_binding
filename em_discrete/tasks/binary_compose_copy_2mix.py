        ...
        for i in range(2000):
            ...
            for step in range(self.horizon):
                ...
                if mix_mode == 1:
                    ...
                    y_sample[composed_seq_id, :, :three_block] = -y_sample[
                        compose_seq_id_1, :, three_block : 2 * three_block
                    ]
                    y_sample[composed_seq_id, :, three_block : 2 * three_block] = (
                        y_sample[compose_seq_id_2, :, -three_block:]
                    )

                mix_mode = (mix_mode + 1) % 2
